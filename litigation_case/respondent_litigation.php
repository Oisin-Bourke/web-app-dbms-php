...
?>
    ...
    <form class="form-inline">
        ...
        <a class="btn btn-success" role="button" href="add_respondent_litigation.php?Case_ID=<?php echo $Case_ID; ?>">Click</a>
    </form>
...
$Case_ID = mysqli_escape_string($conn, $_GET['Case_ID']);
$sql = "select * FROM LITIGATION_CORRESPONDENT WHERE Case_ID=$Case_ID";
